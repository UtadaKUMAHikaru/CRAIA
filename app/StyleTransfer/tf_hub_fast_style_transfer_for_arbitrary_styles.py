...
content_image_path = 'Golden_Gate_Bridge_from_Battery_Spencer.jpeg'  # @param {type:"string"}
style_image_path = 'The_Great_Wave_off_Kanagawa.jpeg'  # @param {type:"string"}
content_image_url = content_image_path
style_image_url = style_image_path
...
content_image = load_image_path(content_image_url, content_img_size)
style_image = load_image_path(style_image_url, style_img_size)
...
style_paths = dict(
  kanagawa_great_wave='style_images/The_Great_Wave_off_Kanagawa.jpg',
  ...
  picasso_bottle_of_rum='style_images/Pablo_Picasso,_1911,_Still_Life_with_a_Bottle_of_Rum,_oil_on_canvas,_61.3_x_50.5_cm,_Metropolitan_Museum_of_Art,_New_York.jpeg',
...
content_images = {k: load_image_path(v, (content_image_size, content_image_size)) for k, v in content_urls.items()}
style_images = {k: load_image_path(v, (style_image_size, style_image_size)) for k, v in style_urls.items()}
